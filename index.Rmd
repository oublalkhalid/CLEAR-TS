---
title: '**LEAR: Disentangling Time Series for Interpreting and Explaining Latent
Representations via Contrastive Sparsity-Inducing**'
subtitle: Extended Results - Benchmarking
output:
  html_document:
    theme: cerulean
    highlight: pygments
...
# Experiment #1 (Extending Table 2 of the main paper by including results comparing to iTransformer, Informer and others)
...
# Experiment #2 (Extending Table 2 of the main paper by including results comparing to iTransformer, Informer and others)
```{r child=if (fast == FALSE) '2_inferential.Rmd'}
```
## Short Analysis
